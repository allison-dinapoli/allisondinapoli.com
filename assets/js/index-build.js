    ...
    _createClass(Base, [{
        ...
        value: function render() {
            var linkedIn = _react2.default.createElement(
                ...
                _react2.default.createElement("img", { src: "./assets/img/linkedin.svg", style: { width: "40px", maxWidth: "10%" } })
            );
            var email = _react2.default.createElement(
                "a",
                { href: "mailto:adinapol@asu.edu" },
                _react2.default.createElement("img", { src: "./assets/img/email.svg", style: { width: "40px", maxWidth: "10%" } })
            );
            var github = _react2.default.createElement(
                "a",
                { href: "https://github.com/allison-dinapoli" },
                _react2.default.createElement("img", { src: "./assets/img/github.svg", style: { width: "40px", maxWidth: "10%" } })
            );
